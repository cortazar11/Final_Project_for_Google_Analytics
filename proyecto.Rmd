...
```{r}
    #x <- df$diff_double  #Continuous variable
    #y <- df$member_casual  # Qualitative variable
    
    # Logistic Regression
    fit <- glm(member_casual~diff_double,data=df,family=binomial)
    summary(fit)
```

1. Una unidad de incremento en la variable tiempo de uso (diff_double) esta asociada con un cambio medio de -4.152e-04 en el registro de probabilidades.
