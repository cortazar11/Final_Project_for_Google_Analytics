...
En este paso de limpieza podemos comprobar como en la diferenci del tiempo de recogida de la bicicleta y el tiempo de dejarla hay valores negatios y valores que son cero.
...
1. En una primera introducción al análisis tenemos los sigueintes resultado:
...
Asi mismo una primera estadística nos da:
