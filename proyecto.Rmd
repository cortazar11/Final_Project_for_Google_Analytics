...
```
Para el cambio en el nombre en los campos de ficheros de ls segunda base de datos ( a partir primer trimestre 2020) y siguiente derivación en nuvos ficheros:
